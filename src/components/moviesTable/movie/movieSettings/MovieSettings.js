...
export default function MovieSettings({ setOpenSettings, setModal, movieData }) {
  ...
  return (
    <div className='moviesCollection__editContainer'>
      ...
      <ul className='moviesCollection__listBtns'>
        <li onClick={() => setModal(<EditMovie movieData={movieData} />)} className='moviesCollection__btn'>Edit</li>
